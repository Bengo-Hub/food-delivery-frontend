      ...
      >
        ...
        <div className="border-t border-border bg-muted/30 px-5 py-6">
          ...
          <div className="mt-5 flex gap-3">
            <Button variant="outline" size="lg" className="h-auto flex-1 rounded-full border-border bg-background px-4 py-2 shadow-sm transition-all hover:shadow-md" asChild>

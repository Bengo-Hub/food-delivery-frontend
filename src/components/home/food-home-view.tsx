...
/**
 * FoodHomeView — the hospitality/quick_service homepage. This is a near-verbatim
 * extraction of the original monolithic src/app/[orgSlug]/page.tsx body (the
 * Uber-Eats-shaped layout), unchanged in behavior: sticky icon-rail CategoryCarousel,
 * FilterBar, promo banners, featured items carousel, and the outlet-section rail
 * (Featured / Most reviewed / Near you / Popular / Today's offers / Top 10 / All stores).
 */
